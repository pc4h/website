    ...
    return (
        <div class="min-h-screen flex items-center justify-center">
            <div class="font-poppins">
                ...
                <div class="col-span-full w-screen relative h-5/6 py-10 ">
                ...
                <div class="col-span-full w-screen relative bg-gray-300 py-10">
                    <h1 class="text-xl font-semibold text-slate-800 dark:text-white mx-14 lg:text-black">
                        Our Mission
                    </h1>
                    <p class="mt-2 text-base leading-snug dark:text-gray-300 mx-4">
                ...
                <div class="grid mt-12 gap-y-10 py-auto relative right-0 gap-0 bottom-10 mx-4 lg:grid-cols-2 lg:gap-x-10">
